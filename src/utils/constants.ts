...
const AVANTIS_SOCKET_API = "https://socket-api.avantisfi.com/v1/data"

const CONTRACT_ADDRESSES = MAINNET_ADDRESSES

export { MAINNET_ADDRESSES, AVANTIS_SOCKET_API, CONTRACT_ADDRESSES }
